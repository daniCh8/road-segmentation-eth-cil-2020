...
class NNet:
    def __init__(self, val_split=.0, model_to_load='None', net_type='uxception'):
        assert net_type in ['uxception', 'uresxception', 'uresxceptionsp', 'deepuresnet', 'uresnet50v2'], "net_type must be one of ['uxception', 'uresxception', 'uresxceptionsp', 'deepuresnet', 'uresnet50v2']"
